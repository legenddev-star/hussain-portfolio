  ...
  return (
    <div className="min-h-screen p-4 md:p-8">
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:col-span-2 md:col-span-3 lg:col-span-4 lg:grid-cols-2 xl:col-span-6">
        ...
        <div className="grid grid-cols-1 gap-4 sm:col-span-2 md:col-span-3 lg:col-span-4 lg:grid-cols-2 xl:col-span-6">
          ...
          <div className="flex flex-col">
            <div className="grid grid-cols-1 gap-4 bg-gradient-to-br from-blue-100 to-indigo-100 px-4 py-12 dark:from-gray-900 dark:to-indigo-900 sm:col-span-2 sm:px-6 md:col-span-3 lg:col-span-4 lg:grid-cols-2 lg:px-8 xl:col-span-6">
              <div className="flex flex-col">
                <Languages />
              </div>
              <div className="flex flex-col">
